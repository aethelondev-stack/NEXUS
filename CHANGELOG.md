...
- **True MCP Transport for ARGUS:** `ArgusAdapter` connects directly to ARGUS FastMCP server via `mcp.client.stdio.stdio_client` and `ClientSession` with fast Win32 direct shell fallback.
