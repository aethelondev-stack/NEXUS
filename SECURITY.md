...
4. **Path Traversal Protection:** BUBU and NEXUS strictly validate file boundaries, ensuring file arguments resolve within designated project trees to prevent unauthorized filesystem read/write operations.
...
- Please report it responsibly via GitHub Security Advisories at [https://github.com/aethelondev-stack/NEXUS/security/advisories](https://github.com/aethelondev-stack/NEXUS/security/advisories).
